...
def fetch_docx_from_github("https://raw.githubusercontent.com/nagarajuprojects/repository/main/"):
    response = requests.get("https://raw.githubusercontent.com/nagarajuprojects/repository/main/")
